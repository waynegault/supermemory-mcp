...
declare namespace Cloudflare {
	interface Env {
		...
		AUTH_SECRET: string;
		MY_DO: DurableObjectNamespace<import("./workers/app").MyDurableObject>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPERMEMORY_API_KEY" | "AUTH_SECRET">> {}
}
